...
class Database:
    ...
    def _create_tables(self):
        """Create database tables with proper foreign key handling."""
        ...
        if existing_schema:
            ...
            if not has_created_at_default:
                ...
                logger.info("Foreign key constraints temporarily disabled")
                ...
                logger.info("All existing tables dropped safely")
